...
export default function AuthForm({ onAuthSuccess }: AuthFormProps) {
    ...
    return (
        <div className="min-h-screen flex items-center justify-center p-4 bg-gradient-to-br from-[#c2a1ff] via-pink-100 to-[#ffee8c] font-sans">
            <div className="w-full max-w-md backdrop-blur-md bg-white/60 rounded-3xl p-8 shadow-2xl transition-all duration-500">
                <div className="flex items-center justify-center gap-3 mb-6">
                    <div className="text-4xl">🐼</div>
                    <h1 className="text-4xl font-bold text-black">ZenFi</h1>
                </div>
